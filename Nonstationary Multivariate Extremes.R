...
# INPUTS:
# d: matrix with two columns- 1st spectral sample/2nd associated covariates
# nu: smoothing parameter
# b: bandwidth
# grid_w: points where to evaluate the density on the w-axis
# grid_x: points where to evaluate the density on the x-axis
# OUTPUT: matrix with spectral density
...
## IMPLEMENTATION OF THE EUCLIDEAN LIKELIHOOD ESTIMATOR
# INPUTS:
# d: spectral sample
# x: associated covariate level
# nu: smoothing parameter
# grid_w: points where to evaluate the density on the w-axis
# OUTPUT: vector with the estimated spectral density
...
## IMPLEMENTATION OF THE WEIGHTS OF EUCLIDEAN LIKELIHOOD ESTIMATOR
# INPUTS:
# d: spectral sample
# OUTPUT: vector of weigths
p <- function(d){
...
# grid_w: points where to evaluate the density on the w-axis
# grid_x: points where to evaluate the density on the x-axis
# OUTPUT: matrix with estimated spectral density
